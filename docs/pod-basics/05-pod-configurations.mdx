...
Pods can be constructed in a number of different ways to serve the needs of your organization. All potential configurations are different combinations of roles ([the manager and the member](docs/pod-basics/03-pod-roles-membership.md)) and who holds those roles (roles can be held by an EOA, a pod, or a smart contract).
